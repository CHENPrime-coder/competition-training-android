...
class _TaskPageState extends State<TaskPage> {
  ...
  initData() async {
    //先后顺序控制
    return getAllTasks().then((value) async {
      return await getAllUsersWithUsers(value);
    });
  }

  Future getAllTasks() async {
    dynamic res = await TaskDio.getAllTask();
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            GestureDetector(
                                              onTap: () {
                                                CurrentUser.selectUser = publishers[tasks[tasks.length-index-1]["tid"].toString()];
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text("更新进度", style: Theme.of(context).textTheme.subtitle2,),
